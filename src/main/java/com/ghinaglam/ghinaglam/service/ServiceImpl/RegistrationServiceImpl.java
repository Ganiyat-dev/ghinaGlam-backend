...
import com.ghinaglam.ghinaglam.dto.EmailValidator;
import com.ghinaglam.ghinaglam.dto.RegistrationRequestDto;
import com.ghinaglam.ghinaglam.email.EmailSenderService;
...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    public String register(RegistrationRequestDto request) {
        ...
        String link = "http://localhost:9090/api/v1/user/register/confirm?token=" + token;
